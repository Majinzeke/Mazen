...
fun WorkoutEntryTopBar(
    ...
    CenterAlignedTopAppBar(
        ...
        actions = {
            ...
            if (selectedWorkoutEntry != null) {
                DeleteWorkoutEntryAction(
                    selectedWorkoutEntry = selectedWorkoutEntry,
...
fun DeleteWorkoutEntryAction(
    ...
    DisplayAlertDialog(
        title = "Delete",
        message = " Are you sure you want to delete this '${selectedWorkoutEntry?.exerciseName} ",
