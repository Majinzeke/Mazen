...
@Composable
fun MazenTabRow(
    allScreens: List<MazenNavigationActions>,
    onTabSelected: (MazenNavigationActions) -> Unit,
    currentScreen: MazenNavigationActions
) {
    Surface(
        Modifier
            .height(TabHeight)
